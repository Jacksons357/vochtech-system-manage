<div class="p-4">
    ...
    <div class="flex items-center justify-between gap-3 mb-4 w-full">
        ...
        <div>
            <button wire:click="$dispatch('open-export-modal')"
                class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:cursor-pointer flex items-center gap-2">
                <flux:icon name="document" class="w-5 h-5" />
                Exportar Excel
            </button>

            <livewire:employees.export-modal />
        </div>
    </div>
